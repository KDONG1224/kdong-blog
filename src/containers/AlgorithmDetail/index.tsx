...
// styles
import { StyledAlgorithmDetail } from './style';
...
interface AlgorithmDetaillProps {
  article: ResponseArticleDetailResultProps;
}

export const AlgorithmDetail: React.FC<AlgorithmDetaillProps> = ({
  article
}) => {
